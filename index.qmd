...
$sectionPin.style.height = '10%';
$sectionPin.style.overflow = 'visible'; // To make position sticky work …

/* Stick to Top */
$pinWrapSticky.style.height = '100%';
$pinWrapSticky.style.width = '100%';
...
if ('ViewTimeline' in window) {
  ...
  $pinWrap.style.width = '250%';  // You can adjust this width to match your layout
  ...
  window.addEventListener('scroll', () => {
    ...
    if (scrollY >= stickyPanelTop && scrollY < stickyPanelTop + stickyPanelHeight) {
      ...
      const transformValue = `translateX(${(-200 * scrollPercentage)}vw)`;
      $pinWrap.style.transform = transformValue;

      // Apply transition for smooth movement while scrolling
      $pinWrap.style.transition = 'transform 0.5s ease-out'; // Smooth during scroll
    }
    ...
    // 2. Stop animation at the end of sticky panel
      ...
      $pinWrap.style.transform = `translateX(-35%)`;
      $pinWrap.style.transition = 'transform 1s ease-out'; // Apply smooth transition at the end
    } 
